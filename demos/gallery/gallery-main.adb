-----------------------------------------------------------------------
--  gallery -- Display pictures on the STM32 touch screen
...
with UI.Displays;
with Gallery.Display.Instances;

--  The main Gallery task initializes the board and display and loops to wait
--  for a display timeout or user touch event.
procedure Gallery.Main is
...
begin
   ...
   UI.Displays.Push_Display (Gallery.Display.Instances.Display'Access);
